...
public class CNP {
     ...
     * @return
     */
    public static boolean isValidCPF(String ssnMasked) {
        String ssn = ssnMasked.trim().replace(".", "").replace("-", "");
     ...
     * @return
     */
    public static boolean isValidCNPJ(String tfnMasked) {
        String tfn = tfnMasked.trim().replace(".", "").replace("-", "").replace("/", "");
