...
public class meiosPagamentosAdapterManual extends RecyclerView.Adapter<meiosPagamentosAdapterManual.MeiosPagamentosAdapterViewHolder> {

    private List<PaymentCompany> companyPayments;
    private meiosPagamentoOnClickListener listener;

    meiosPagamentosAdapterManual(meiosPagamentoOnClickListener handler) {
        listener = handler;
    }
    ...
    public MeiosPagamentosAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        int layoutIdForListItem = R.layout.manual_rv_company_payment;
