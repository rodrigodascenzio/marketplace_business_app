...
public class FrAvaliacoes extends Fragment implements
    ...
    public static FrAvaliacoes newInstance(Company company) {
        FrAvaliacoes fragment = new FrAvaliacoes();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        fabError.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loaderManager.restartLoader(0, null, FrAvaliacoes.this);
            }
        });
    ...
    public Loader<List<Order>> onCreateLoader(int id, Bundle args) {
        return new RatingLoader(getActivity(), company.getCompany_id(), data1timestamp, data2timestamp, data);
    }
    ...
    private static class RatingLoader extends AsyncTaskLoader<List<Order>> {

        Context ctx;
        String stoId, data1, data2;
        List<Order> data;

        RatingLoader(Context context, String stoId, String data1, String data2, List<Order> data) {
            super(context);
            ctx = context;
            this.stoId = stoId;
            this.data1 = data1;
        ...
        public List<Order> loadInBackground() {
            Gson gson = new Gson();
            String stringJson = ConnectApi.GET(ConnectApi.ORDER_AVALIACOES + "/" + stoId + "," + data1 + "," + data2 + "," + Util.returnStringLatLonCountr(getContext()), getContext());
            JsonParser parser = new JsonParser();
            try {
                JsonObject jObj = parser.parse(stringJson).getAsJsonObject();
                Order[] orders = gson.fromJson(jObj.getAsJsonArray(AppConstants.RATING), Order[].class);
