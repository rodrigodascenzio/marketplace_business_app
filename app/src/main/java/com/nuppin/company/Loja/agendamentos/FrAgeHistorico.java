...
public class FrAgeHistorico extends Fragment implements
    ...
    private RvAgeHistoricoAdapter adapter;
    ...
    public static FrAgeHistorico newInstance(Company company) {
        FrAgeHistorico fragment = new FrAgeHistorico();
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        ...
        fabError.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                loaderManager.restartLoader(0, null, FrAgeHistorico.this);
            }
        });
        ...
        adapter = new RvAgeHistoricoAdapter();
    ...
    private static class FinanceiroLoader extends AsyncTaskLoader<List<Scheduling>> {
        ...
        public List<Scheduling> loadInBackground() {
            Gson gson = new Gson();
            String stringJson = ConnectApi.GET(ConnectApi.SCHEDULING_HISTORICO + "/" + stoId + "," + data1 + "," + data2, getContext());
            JsonParser parser = new JsonParser();
            try {
                JsonObject jObj = parser.parse(stringJson).getAsJsonObject();
                Scheduling[] request = gson.fromJson(jObj.getAsJsonArray(AppConstants.SCHEDULING), Scheduling[].class);
                return new ArrayList<>(Arrays.asList(request));
            } catch (Exception e) {
