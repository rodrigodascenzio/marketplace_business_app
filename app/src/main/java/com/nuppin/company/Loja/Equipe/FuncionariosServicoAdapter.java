...
public class FuncionariosServicoAdapter extends RecyclerView.Adapter<FuncionariosServicoAdapter.FuncionariosServicoAdapterViewHolder> {

    private List<Employee> employees;
    private FuncionariosServicoAdapterListener listener;

    public FuncionariosServicoAdapter(){}

    public FuncionariosServicoAdapter(FuncionariosServicoAdapterListener listener) {
        this.listener = listener;
    }

    public class FuncionariosServicoAdapterViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {

        TextView func, txtHorario, btnTxt, cargo, voce;

        FuncionariosServicoAdapterViewHolder(View view){
            super(view);
        ...
        public void onClick(View view) {
            listener.desvincularFuncionarioServico(employees.get(getAdapterPosition()));
        }
    }

    @NonNull
    @Override
    public FuncionariosServicoAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        ...
        return new FuncionariosServicoAdapterViewHolder(view);    }

    @Override
    public void onBindViewHolder(@NonNull FuncionariosServicoAdapterViewHolder holder, int position) {
        holder.btnTxt.setVisibility(View.VISIBLE);
        holder.voce.setVisibility(View.GONE);

        holder.btnTxt.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_clear_black_24dp,0,0,0);
    ...
    public interface FuncionariosServicoAdapterListener {
        void desvincularFuncionarioServico(Employee employee);
    }
}
